...
export default function DiagnosticPreferenceScreen() {
  ...
  const handleComplete = async () => {
    if (!selectedDiagnostic) {
      showToast({
        type: 'error',
        title: 'Select Diagnostic Type',
        message: 'Please choose your preferred diagnostic type',
      });
      return;
    }
    ...
    try {
      ...
      // Update preferences with selected diagnostic type
      await updateProfile({
        preferences: {
          diagnosticType: selectedDiagnostic as 'quick' | 'full',
          notifications: true,
          dataUsage: true,
          messaging: true,
        },
