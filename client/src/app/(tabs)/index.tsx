        ...
        <View className="card">
          ...
          <View className="bg-gray-200 rounded-full h-2">
            <View 
              ...
              style={{ width: `${(stats?.level?.xpCurrent || 0) / (stats?.level?.xpRequired || 100) * 100}%` }}
            />
          </View>
          <Text className="text-body-sm text-text-secondary font-inter text-center mt-2">
            {stats?.level?.xpCurrent || 0} / {stats?.level?.xpRequired || 100} XP to next level
          </Text>
        </View>
      </View>
